...
Router.route("/division/:id").post(isAuthenticated, getSingleDivision) 
...
Router.route("/division/myDivision/:div/:course/:clgShortName/:year").post(isAuthenticated,getDivisionByData) 
